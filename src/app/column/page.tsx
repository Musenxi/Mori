      ...
      <main className="mx-auto w-full max-w-[1440px] px-5 pb-8 md:px-0">
        <section className="flex flex-col gap-8 py-10 md:gap-[60px] md:px-[80px] md:py-[80px] md:pl-[400px]">
          <header className="flex items-center gap-5 md:gap-8">
            <h1 className="font-serif-cn text-[32px] font-bold leading-[1.4] tracking-[4px] text-primary md:text-[36px]">
              专栏
            </h1>
            <span className="font-serif-cn text-lg text-muted md:text-xl md:tracking-[6px]">分类</span>
          </header>
          ...
          {columns.length > 0 ? (
            ...
            <p className="font-sans text-sm leading-8 text-secondary">暂无专栏数据。</p>
          )}
        </section>
      </main>
    </Shell>
